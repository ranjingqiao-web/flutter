  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
     appBar:AppBar(brightness: Brightness.light,) ,
      body: MyFlutterRefreshPage(title:"data"),
    );
  }
}
  ...
  Widget _item(index) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: Colors.white,
            border: Border(left: BorderSide(width: 1.0, color: Colors.yellow))),
        child: Column(
          children: <Widget>[
            Image.network(RecommendList[index]['imgSrc']),
            Text(
              "data${RecommendList[index]['imgSrc']}",
              overflow: TextOverflow.ellipsis,
              maxLines: 1,
            ),
            Text(
              "data${RecommendList[index]['id']}",
              style: TextStyle(
...
class FloorTitle extends StatelessWidget {
  ...
  const FloorTitle(
      ...
      this.picture_address:
          "http://picture3.51zhaomen.com/upload_pic_品牌馆广告2.jpg"})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
